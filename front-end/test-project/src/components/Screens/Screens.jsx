  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="flex gap-2 font-medium">
        Path : <span className="font-light">/auth/forgot-password</span>
      </div>
      ...
      <div className="min-h-screen font-sans text-violet-950 py-8">
        <div className="max-w-4xl ">
          ...
          <div className="rounded-xl border border-violet-200 mt-8 shadow-sm p-6">
            <div className="font-light text-violet-800 text-lg mb-2">
              Welcome
            </div>
            <div className="overflow-x-auto">
              <table className="w-full mt-2 border-collapse text-base">
                <thead>
                  <tr>
                    <th className="text-left px-3 py-2 text-violet-600 font-light">
                      Name
                    </th>
                    <th className="text-right px-3 py-2 text-violet-600 font-light">
                      Passed
                    </th>
                    <th className="text-right px-3 py-2 text-violet-600 font-light">
                      Failed
          ...
          <div className="rounded-xl border border-violet-200 mt-8 bg-white shadow-sm p-6">
            ...
            <div className="overflow-x-auto">
              <table className="w-full mt-2 border-collapse text-base">
                <thead>
                  <tr>
                    <th className="text-left px-3 py-2 text-violet-700 font-light">
                      Name
                    </th>
                    <th className="text-right px-3 py-2 text-violet-700 font-light">
                      Passed
                    </th>
                    <th className="text-right px-3 py-2 text-violet-700 font-light">
                      Failed
